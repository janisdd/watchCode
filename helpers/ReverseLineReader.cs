...
{
    //from https://stackoverflow.com/questions/452902/how-to-read-a-text-file-reversely-with-iterator-in-c-sharp
        ...
        private IEnumerator<string> GetEnumeratorImpl(Stream stream)
        {
            try
            {
                ...
                while (position > 0)
                {
                    ...
                    ReverseLineReader.ReadExactly(stream, buffer, bytesToRead);
